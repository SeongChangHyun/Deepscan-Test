...
import { mockTargetingTimeData } from '@/mock/data/targeting-reports'
...
export default {
  ...
  data() {
    return {
      ...
      expandUniqueValues: [],
      tableData: mockTargetingTimeData,
      componentKey: 0,
      rows: Common.Rows,
  ...
  methods: {
    ...
    onSelectItemFilter(filterParams) {
      this.onChangeFilterParams(filterParams)
    },
    filterData(data, key) {
