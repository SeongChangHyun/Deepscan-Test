    ...
    <el-row :gutter="10">
      <el-col :span="12">
        <el-form ref="nativeForm" :model="formData" :rules="rules" class="native-ads-form">
          ...
          <el-form-item :label="genI18n('campaignImage')" prop="campaign_image">
            <el-upload
              :auto-upload="false"
              :on-change="uploadCampaignImage"
              class="upload-single-image"
              action="https://jsonplaceholder.typicode.com/posts/">
              <span v-if="formData.campaign_image" class="upload-file-name">{{ formData.campaign_image }}</span>
              <el-button size="medium" type="info">{{ genI18n('browser') }}</el-button>
              <div slot="tip" class="el-upload__tip">{{ genI18n('campaignImageRule') }}</div>
            </el-upload>
          </el-form-item>
