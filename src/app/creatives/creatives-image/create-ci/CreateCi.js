  ...
  data() {
    return {
      ...
      defaultCiData: {
        ...
        showAdvancedOptions: ['target_goal'],
        detailOptions: [
          { id: 1, title: 'clickURLTitle', description: 'desktopMobileDescription', allowEdit: false, value: '' },
          { id: 2, title: 'impressionCheckURLTitle', description: 'desktopMobileDescription', allowEdit: false, value: '' },
          { id: 3, title: 'clickURLTitle', description: 'androidAppDescription', allowEdit: false, value: '' },
          { id: 4, title: 'impressionCheckURLTitle', description: 'androidAppDescription', allowEdit: false, value: '' },
          { id: 5, title: 'clickURLTitle', description: 'iosAppDescription', allowEdit: false, value: '' },
          { id: 6, title: 'impressionCheckURLTitle', description: 'iosAppDescription', allowEdit: false, value: '' },
          { id: 7, title: 'clickURLTitle', description: 'pageLinkDescription', allowEdit: false, value: '' },
          { id: 8, title: 'impressionCheckURLTitle', description: 'pageLinkDescription', allowEdit: false, value: '' }
        ],
        advancedOptions: {
          rollingInterval: '',
