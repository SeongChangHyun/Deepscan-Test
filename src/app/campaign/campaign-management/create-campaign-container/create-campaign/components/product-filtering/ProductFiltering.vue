<template>
  <el-row class="h-form-input w-100 pt-0 pb-1 bottom-dote-line schedule-field">
    ...
    <div :class="{ 'show': showContent }" class="el-col-md-18 el-col-sm-18 el-col-xs-24 float-right px-0 mt-3 transition-height">
      <div v-show="showContent" class="content-fields container-tree">
        ...
        <el-row class="h-form-input container-item mt-3">
          <ItemList
        ...
        <el-row class="h-form-input">
          <el-col :span="4" :offset="20" class="remove-all-btn">
            <span class="button-black" @click="removeSelectedAll">{{ genI18n('deleteAllBtn') }}</span>
          </el-col>
        </el-row>
        <p>{{ genI18n('selectedProduct') }}</p>
        <el-row class="h-form-input container-item" style="background:#fff">
          <el-row class="label">
            <el-col :span="2" :offset="1">{{ genI18n('labelId') }}</el-col>
            <el-col :span="15">{{ genI18n('labelName') }}</el-col>
            <el-col :span="2">{{ genI18n('labelPrice') }}</el-col>
          </el-row>
          <ItemTable
