      ...
      <div v-show="showContent" class="content-fields h-form-input w-100 ">
        ...
        <div class="w-100 container-table">
          <div class="fl-1 content">
            <p class="header">Allow position</p>

            <div class="item header-action">
              <span class="lable fl-1">2 position</span>
              <el-button type="danger" size="mini">DEL ALL</el-button>
            </div>

            <div class="list">
              <div class="item">
                <span class="lable fl-1">currency</span>
                <span class="total">50,000</span>
            ...
            <div class="item footer-input">
              <input class="input fl-1" type="text">
          ...
          <div class="fl-1 content">
            <p class="header">Block position</p>
            <!-- fixed -->

            <div class="item header-action">
              <span class="lable fl-1">0 position</span>
              <el-button type="danger" size="mini">DEL ALL</el-button>
            </div>
