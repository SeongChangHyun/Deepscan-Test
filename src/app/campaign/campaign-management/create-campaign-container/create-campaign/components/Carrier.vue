    ...
    >
      <div v-show="showContent" class="content-fields h-form-input w-100">
        <el-radio-group v-model="value">
          <el-radio label="all" class="w-100">{{ genI18n('allCarrier') }}</el-radio>
          <el-radio label="custom" class="w-100">{{ genI18n('specificCarrier') }}</el-radio>
        </el-radio-group>
        <el-row v-if="value == 'custom' ">
          <div class="content-custom">
            ...
            <p>{{ genI18n('selected') }} {{ genI18n('title') }}</p>
